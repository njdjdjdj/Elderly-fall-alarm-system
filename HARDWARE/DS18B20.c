...
void delay_us(unsigned long z)  //时序问题调节这里，STM32F103C8T6  64MHZ是 5 ，如果不稳定再调节
{
	z=z*10;
  while(z--);
}
...
void DS18B20_DQ_IN()
{
 	...
 	GPIO_InitStruct.Pin = DS18B20_Dout_PIN;				//PORTG.11 推挽输出
...
unsigned char DS18B20_Init(void)
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
 	...
 	HAL_GPIO_WritePin(DS18B20_Dout_PORT,DS18B20_Dout_PIN,GPIO_PIN_SET);    //输出1
